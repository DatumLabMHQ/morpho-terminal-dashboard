# Morpho Research Terminal

Morpho as a sector: every listed market and vault on every chain, curators, share of chain lending, and the positions behind each market, built on the Datum data platform.
...
Deploy: `vercel link --scope datumlabs1 --project morpho-terminal-dashboard`, add `DATUM_API_URL` and `DATUM_API_KEY`, push to main.
